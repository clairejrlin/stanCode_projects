...
For program to add and read the baby name files.
"""
    ...
    with open(filename, 'r') as f:
        for line in f:
            ...
            if len(filename_lst) == 1:
                ...
                rank = filename_lst[0]
                rank = rank.strip()
                male_name = filename_lst[1]
                male_name = male_name.strip()
                female_name = filename_lst[2]
...
def search_names(name_data, target):
    ...
    matching_names = []
    target_1 = target.lower()
    target_2 = target[0].upper()+target[1:].lower()
    # print(target_1)
    # print(target_2)

    for name in name_data:
        index_1 = name.find(target_1)
        index_2 = name.find(target_2)
